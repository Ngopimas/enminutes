...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    heroSubtitle:
      "Explorez l'évolution du pouvoir d'achat en France depuis 1950, mesurée en minutes de SMIC.",
    heroSubtitleMedian:
    ...
    heroFactMinutes: "minutes de SMIC pour acheter",
    ...
    insightEssenceSub:
      "Malgré les fluctuations de prix, un litre d'essence coûte entre 8 et 10 minutes de SMIC depuis les années 1990.",
    insightCinema: "Cinéma : un luxe relatif croissant",
    insightCinemaSub:
      "Malgré la baisse spectaculaire depuis 1950 (53→39 min), le cinéma stagne en accessibilité depuis 20 ans.",
    ...
    methodologyText:
      "Pour chaque produit et chaque année, le temps de travail est calculé ainsi\u202F: minutes = (prix / SMIC horaire) × 60. Les prix intermédiaires sont estimés par interpolation linéaire entre les points de données connus.",
    sourcesSmicLabel: "SMIC horaire",
    sourcesSmicDesc: "Historique officiel du salaire minimum",
    ...
    sourcesFormula: "minutes = (prix / SMIC horaire) × 60",
    footerText:
    ...
    ppChartYLabel2: "Minutes de SMIC par produit (moy.)",
    ...
    salaryRefSmic: "SMIC",
    salaryRefSmicDesc: "Salaire minimum brut",
  ...
  en: {
    ...
    heroSubtitle:
      "Explore the evolution of purchasing power in France since 1950, measured in minutes of minimum wage.",
    heroSubtitleMedian:
    ...
    heroFactMinutes: "minutes of minimum wage to buy",
    ...
    insightEssenceSub:
      "Despite price swings, a litre of petrol costs 8-10 minutes of minimum wage since the 1990s.",
    insightCinema: "Cinema: a growing relative luxury",
    insightCinemaSub:
      "Despite the spectacular drop since 1950 (53→39 min), cinema accessibility has stagnated for 20 years.",
    historyTitle: "Historical Milestones",
    historySub: "Key dates of the French minimum wage",
    sourcesTitle: "Methodology & Sources",
    methodologyText:
      "For each product and year, work-time is calculated as: minutes = (price / hourly minimum wage) × 60. Intermediate prices are estimated through linear interpolation between known data points.",
    sourcesSmicLabel: "Hourly SMIC",
    sourcesSmicDesc: "Official minimum wage history",
    ...
    sourcesFormula: "minutes = (price / hourly min. wage) × 60",
    footerText:
    ...
    ppChartYLabel2: "Minutes of SMIC per product (avg.)",
    ...
    salaryRefSmicDesc: "Gross minimum wage (SMIC)",
