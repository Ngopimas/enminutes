...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    sourcesIrlDesc: "Indice légal trimestriel de révision des loyers (base 100 = Q4 2022). Utilisé pour projeter le loyer national moyen depuis 2006.",
    sourcesDreesLabel: "DREES / SNDS",
    sourcesDreesDesc: "Données statistiques sur les rémunérations des médecins libéraux en secteur 2 (honoraires totaux incluant dépassements). Source : DREES Données statistiques.",
  ...
  en: {
    ...
    sourcesIrlDesc: "Legal quarterly rent revision index (base 100 = Q4 2022). Used to project national average rent from 2006 onward.",
    sourcesDreesLabel: "DREES / SNDS",
    sourcesDreesDesc: "Statistical data on self-employed physician fees in sector 2 (total fees including excess charges). Source: DREES statistical reports.",
