...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    sourcesOlapDesc:
      "Loyers de marché à Paris intra-muros (remises en location)",
    ...
    sourcesIrlLabel: "INSEE IRL (Indice de Référence des Loyers)",
    sourcesIrlDesc:
      "Indice légal trimestriel de révision des loyers (base 100 = Q4 2022). Utilisé pour projeter le loyer national moyen depuis 2006.",
    sourcesDreesLabel: "DREES / SNDS",
    sourcesDreesDesc:
      "Données statistiques sur les rémunérations des médecins libéraux en secteur 2 (honoraires totaux incluant dépassements). Source : DREES Données statistiques.",
    sourcesManualLabel: "Sources manuelles vérifiées",
    sourcesManualDesc:
      "Netflix France (streaming) · Lesnumériques (smartphone) · Peugeot France (automobile) · La Poste (timbre) · Tabac Info Service (cigarettes)",
  ...
  en: {
    ...
    sourcesIrlLabel: "INSEE IRL (Rent Reference Index)",
    sourcesIrlDesc:
      "Legal quarterly rent revision index (base 100 = Q4 2022). Used to project national average rent from 2006 onward.",
    sourcesDreesLabel: "DREES / SNDS",
    sourcesDreesDesc:
      "Statistical data on self-employed physician fees in sector 2 (total fees including excess charges). Source: DREES statistical reports.",
    sourcesManualLabel: "Manually verified sources",
    sourcesManualDesc:
      "Netflix France (streaming) · Lesnumériques (smartphone) · Peugeot France (car) · La Poste (stamp) · Tabac Info Service (cigarettes)",
    ...
    ppChartAriaLabel:
      "SMIC purchasing power trend from 1960 to today, index base 100",
