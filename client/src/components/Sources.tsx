...
const sources = [
  ...
  {
    labelKey: "sourcesSalaryLabel",
    descKey: "sourcesSalaryDesc",
    url: "https://www.insee.fr/fr/statistiques/8660332?sommaire=8660243",
  },
  {
  ...
  },
  {
    ...
    url: "https://www.ipp.eu/baremes-ipp/",
  },
  {
    labelKey: "sourcesFichePaieLabel",
    descKey: "sourcesFichePaieDesc",
    url: "https://fiche-paie.fr/blog/histoire-smic-france-1950-2026",
  },
  {
  ...
  },
  {
    ...
    url: "https://www.arcep.fr/cartes-et-donnees.html",
  },
  {
    labelKey: "sourcesCncLabel",
    descKey: "sourcesCncDesc",
    url: "https://www.cnc.fr/professionnels/etudes-et-rapports/bilans",
  },
  {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-3 p-4 rounded-lg bg-muted/50">
          <p className="text-xs font-medium text-muted-foreground mb-1">
            {t("sourcesMethodLabel")}
          </p>
          <p className="text-sm font-mono tabular-nums">
            {t("sourcesFormula")}
          </p>
          <p className="text-xs text-muted-foreground mt-2">
            {t("sourcesInterpolation")}
          </p>
        ...
        <div className="mb-6 p-4 rounded-lg bg-muted/50">
          <p className="text-xs font-medium text-muted-foreground mb-1">
            {t("sourcesIpcCalibLabel")}
          </p>
          <p className="text-xs text-muted-foreground/70">
            {t("sourcesIpcCalibDesc")}
          </p>
        </div>
